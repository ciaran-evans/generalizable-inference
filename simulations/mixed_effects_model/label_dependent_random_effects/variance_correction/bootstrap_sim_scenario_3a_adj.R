...
simulate_training_data <- function(train_pi, n_obs){
  ...
  train_data <- rnorm(n_obs, 0, 1)*obs_y + 
...
write.table(test_mean_est, file="ls_bootstrap_scenario_3a_adj_estimates.txt")
write.table(bootstrap_mean_est, file="ls_bootstrap_scenario_3a_adj_ci_reps.txt")
