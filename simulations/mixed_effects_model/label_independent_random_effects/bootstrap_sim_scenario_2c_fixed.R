...
write.table(test_mean_est, file="ls_bootstrap_scenario_2c_fixed_estimates.txt")
write.table(bootstrap_mean_est, file="ls_bootstrap_scenario_2c_fixed_ci_reps.txt")
